...
def machine_learning():
    ...
    # Add machine learning-specific code here
    st.write("""
    ...
    model_path = os.path.join(base_path, "models", "loan_model.pkl")
    ...
    if st.button("Predict Loan Approval"):
        ...
        for column in columns_to_encode:
            le = LabelEncoder()
            # Fit encoder on original training data to ensure consistency
